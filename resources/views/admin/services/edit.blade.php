        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li class="text-slate-700 dark:text-zink-100">Edit Service</li>
                </ul>
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                            ...
                            <div class="xl:col-span-12">
                                ...
                                <textarea
                                    ...
                                    required
                                >{{ old('check_list', $service->check_list) }}</textarea>
                                @error('check_list')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="xl:col-span-12">
                                ...
                                @if($service->image)
                                    <div class="mt-3">
                                        <p class="mb-1 text-sm text-slate-600 dark:text-zink-200">Current Image:</p>
                                        <img src="{{ asset('storage/' . $service->image) }}" alt="Service Image" width="120" class="rounded-md border border-slate-200 dark:border-zink-500">
                                    </div>
                                @endif
                            </div>
                        </div>
