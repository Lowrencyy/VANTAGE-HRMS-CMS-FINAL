<footer class="bg-dark text-light">
        ...
        <div class="fixed-shape">
            <img src="{{ asset('main/assets/img/map.svg') }}" alt="Shape">
        </div>
        <!-- Fixed Shape -->
        <div class="container">
                            ...
                            <div class="address">
                                <ul>
                                    <li>
                                        ...
                                        Unit 1702 South Corporate Plaza High Street BGC Taguig City
                                    </li>
                                    <li>
                                        <strong>Email:</strong>
                                        <a href="mailto:info@validtheme.com">Connect@VantageIT.PH</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="download">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p>Copyright © 2025. <a href="#">VantageIT</a></p>
                    </div>
